        ...
        <article className='p-2 m-2 w-full md:w-2/5 flex justify-center items-center'>
          <section>
            ...
            <span className='text-2xl flex flex-wrap justify-center items-center'>
              <button className="m-2 w-full lg:w-fit bg-sky-400 hover:bg-sky-500 text-white font-bold py-2 px-4 rounded">
              ...
              <button className="m-2 w-full lg:w-fit bg-sky-400 hover:bg-sky-500 text-white font-bold py-2 px-4 rounded">
              <svg className="h-8 w-8 text-white inline-block"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M9 13l-4 -4l4 -4m-4 4h11a4 4 0 0 1 0 8h-1" /></svg> 以前のカメラ
              </button>
            </span>
          </section>
        </article>
